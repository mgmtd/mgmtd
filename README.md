...
- erlydtl templates to provide basic Web UI. Suitable for hosting within an existing cowboy UI
...
- [ ] AAA beyond basic roles. CLI maps Unix-domain peer uid; RESTCONF
